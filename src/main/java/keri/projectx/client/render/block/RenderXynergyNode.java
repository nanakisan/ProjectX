...
public class RenderXynergyNode implements IRenderingHandler {
    ...
    public void render(ModelBuilder builder, TextureGetter textureGetter, BlockRenderLayer layer, IBlockState state, EnumFacing face, long random) {
        if(layer == BlockRenderLayer.SOLID){
            builder.setTexture(IconRegistry.getIcon("animation")).setFullbright(true).setColor(new ColourRGBA(100, 255, 255, 255)).addCuboid(new Cuboid6(2D, 0D, 2D, 4D, 2D, 14D));
            builder.setTexture(IconRegistry.getIcon("animation")).setFullbright(true).setColor(new ColourRGBA(100, 255, 255, 255)).addCuboid(new Cuboid6(2D, 0D, 2D, 14D, 2D, 4D));
            builder.setTexture(IconRegistry.getIcon("animation")).setFullbright(true).setColor(new ColourRGBA(100, 255, 255, 255)).addCuboid(new Cuboid6(12D, 0D, 2D, 14D, 2D, 14D));
            builder.setTexture(IconRegistry.getIcon("animation")).setFullbright(true).setColor(new ColourRGBA(100, 255, 255, 255)).addCuboid(new Cuboid6(2D, 0D, 12D, 14D, 2D, 14D));
        }
    ...
    public void renderInventory(ModelBuilder builder, TextureGetter textureGetter, ItemStack stack, long random) {
        builder.setTexture(IconRegistry.getIcon("animation")).setColor(new ColourRGBA(100, 255, 255, 255)).addCuboid(new Cuboid6(2D, 0D, 2D, 4D, 2D, 14D));
        builder.setTexture(IconRegistry.getIcon("animation")).setColor(new ColourRGBA(100, 255, 255, 255)).addCuboid(new Cuboid6(2D, 0D, 2D, 14D, 2D, 4D));
        builder.setTexture(IconRegistry.getIcon("animation")).setColor(new ColourRGBA(100, 255, 255, 255)).addCuboid(new Cuboid6(12D, 0D, 2D, 14D, 2D, 14D));
        builder.setTexture(IconRegistry.getIcon("animation")).setColor(new ColourRGBA(100, 255, 255, 255)).addCuboid(new Cuboid6(2D, 0D, 12D, 14D, 2D, 14D));
