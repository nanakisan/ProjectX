...
import keri.projectx.common.util.DebugHelper;
import keri.projectx.common.util.LanguageHelper;
import keri.projectx.common.util.MathHelper;
...
public class BlockXynergyNode extends BlockBase implements IToolAction, IDebuggerAction {
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
        return MathHelper.minecaftize(new AxisAlignedBB(2D, 0D, 2D, 14D, 5D, 14D));
    }
