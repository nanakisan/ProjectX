...
public class ModPrefs {
    ...
    public static final String VERSION = "0.1.0-test2";
    public static final String DEPS = "";
    public static final String ACC_MC = "1.10.2";
    public static final String CSIDE = "keri.projectx.client.ClientProxy";
    public static final String SSIDE = "keri.projectx.common.CommonProxy";
