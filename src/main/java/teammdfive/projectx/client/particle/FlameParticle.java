...
public class FlameParticle extends Particle {
    ...
    private boolean tinkle;
    private int blendmode;

    public FlameParticle(World world, double x, double y, double z, float scale, float r, float g, float b, int multiplier) {
        ...
        super.particleMaxAge = 2 * multiplier;
        this.multiplier = multiplier;
        //super.noClip = false;
    }

    public FlameParticle(World world, double x, double y, double z, float scale, int type, int multiplier) {
    ...
    public FlameParticle(World world, double d, double d1, double d2, double x, double y, double z, float f, int type, int m) {
    ...
    public void onUpdate() {
        EntityPlayerSP renderentity = Minecraft.getMinecraft().thePlayer;
    ...
    public void renderParticle(VertexBuffer buffer, Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float var16 = 1.0F;
        final int lightMapU = (15 * 0x20) / 0xFFFF;
        final int lightMapV = (15 * 0x20) / 0xFFFF;
